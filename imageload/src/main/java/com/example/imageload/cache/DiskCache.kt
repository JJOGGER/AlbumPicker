...
import com.example.imageload.util.cacheDir
import com.example.imageload.util.hex2Long
import com.example.imageload.util.makeFileIfNotExist
import java.io.File
...
internal object DiskCache {
    ...
    private fun readJournal(map: HashMap<Long, JournalValue>) {
        ...
        if (makeFileIfNotExist(journalFile)) {
            var invalidCount = 0
