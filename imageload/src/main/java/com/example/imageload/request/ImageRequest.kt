...
class ImageRequest private constructor(
    ...
    internal var priority = RenderScript.Priority.NORMAL
...
//}
     ...
     */
    fun sourceKey(sourceKey: String): ImageRequest {
        this.sourceKey = sourceKey
        return this
    }

    fun override(width: Int, height: Int): ImageRequest {
     ...
     */
    fun memoryCacheStrategy(strategy: Int): ImageRequest {
     ...
     */
    fun diskCacheStrategy(strategy: Int): ImageRequest {
     ...
     */
    fun onlyIfCached(onlyIfCached: Boolean): ImageRequest {
        this.onlyIfCached = onlyIfCached
        return this
    }

    fun noClip(): ImageRequest {
        this.noClip = true
        return this
    }

    fun config(config: Bitmap.Config): ImageRequest {
        this.config = config
        return this
    }
     ...
     * @see Priority
     */
//fun priority(priority: Int): ImageRequest {
...
//}
     ...
     */
    fun keepOriginalDrawable(keep: Boolean): ImageRequest {
        keepOriginal = keep
        return this
    }

    fun placeholder(placeholderResId: Int): ImageRequest {
    ...
    fun error(errorResId: Int): ImageRequest {
    ...
    fun goneIfMiss(): ImageRequest {
        this.goneIfMiss = true
        return this
    }

    fun animation(animationId: Int): ImageRequest {
        this.animationId = animationId
        return this
    }

    fun animation(animation: Animation): ImageRequest {
        this.animation = animation
        return this
    }

    @JvmOverloads
    fun fadeIn(duration: Int = 300): ImageRequest {
    ...
    @JvmOverloads
    fun crossFade(duration: Int = 300): ImageRequest {
        if (duration > 0) {
    ...
    fun alwaysAnimation(alwaysAnimation: Boolean): ImageRequest {
     ...
     */
    fun host(host: Any?): ImageRequest {
...
//        }
    ...
    class Builder {
        ...
        fun target(imageView: ImageView): Builder {
